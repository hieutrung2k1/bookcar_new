...
<body>
    <div class="main">
        <div class="header">
            ...
            <ul style="position: relative; left: 100px" class="header_form">
                <li class="header_item">
                    <a class="fontsize_item" href="{{ route('backend.employee.index') }}">Nhân viên</a>
                </li>
                <li class="header_item">
                    <a class="fontsize_item" href="{{ route('backend.product.index') }}">Sản phẩm</a>
                </li>
                <li class="header_item">
                    <a class="fontsize_item" href="{{ route('backend.user.index') }}">Người dùng</a>
                </li>
                <li class="header_item">
                    <a class="fontsize_item" href="{{ route('backend.order.index') }}">Đơn hàng</a>
                </li>
                <li class="header_item">
                ...
                <li class="header_item" onclick="clickHidden('info')">Hi, {{ $_SESSION['email'] }}<span></span>
                <a href="{{ route('frontend.main.logout') }}">Đăng xuất</a>
                </li>
                @else
                <li class="header_item">
